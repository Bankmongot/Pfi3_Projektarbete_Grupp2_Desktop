...
boxes.add(new GraphBox("/Images/ballongBlue.png"));

boxes.add(new GraphBox("/Images/ballongDarkBlue.png"));

boxes.add(new GraphBox("/Images/ballongRed.png"));

boxes.add(new GraphBox("/Images/ballongPurple.png"));



ballongBlue = Toolkit.getDefaultToolkit().getImage(VerticalBoxes.class.getResource("/images/ballongBlue.png"));

ballongDarkBlue = Toolkit.getDefaultToolkit().getImage(VerticalBoxes.class.getResource("/images/ballongDarkBlue.png"));

ballongRed = Toolkit.getDefaultToolkit().getImage(VerticalBoxes.class.getResource("/images/ballongRed.png"));

ballongOrange = Toolkit.getDefaultToolkit().getImage(VerticalBoxes.class.getResource("/images/ballongOrange.png"));
...
if(Math.random() > 0.5) boxes.add(new GraphBox ("ballongBlue"));

else boxes.add(new GraphBox("ballongBlue"));
